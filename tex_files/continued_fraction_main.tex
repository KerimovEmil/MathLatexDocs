...
%Annalen der Physik, 322(10):891–921, 1905.
        ...
        \end{thebibliography}\label{sec:euler's-continued-fraction-formula}\label{sec:general-continued-fraction-examples}\label{sec:general-continued-fraction-examples2}\label{sec:general-continued-fraction-examples3}\label{subsec:pi}\label{sec:euler's-continued-fraction-formula2}
